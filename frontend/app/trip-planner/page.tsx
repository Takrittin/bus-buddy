...
import { TripPlannerResult } from "@/types/insights";
  ...
  return (
    <div className="flex h-screen w-full flex-col overflow-hidden bg-gray-50">
      ...
      <div className="flex flex-1 pt-[60px]">
        ...
        <main className="h-full w-full flex-1 overflow-y-auto pb-24 md:pb-8 md:pl-20">
                    ...
                    >
                      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        <div className="flex items-center gap-4">
                          <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-brand text-xl font-black text-white shadow-lg shadow-brand/20">
                            {plan.routeNumber}
                          </div>
                          <div>
                            <p className="text-lg font-black text-gray-950">{plan.routeName}</p>
